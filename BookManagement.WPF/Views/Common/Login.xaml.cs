...
namespace BookManagement.Views.Common
{
    public partial class Login : Page
    {
        ...
        public Login()
        {
            ...
            var vm = App.Current.Services.GetRequiredService<BookManagement.ViewModels.Common.LoginViewModel>();
            DataContext = vm;
        ...
        private async void Button_Click_Register(object sender, RoutedEventArgs e)
        {
            try
            {
                ...
                string password = (txtRegisterPasswordPlain.Visibility == Visibility.Visible) 
                    ? txtRegisterPasswordPlain.Text 
                    : txtRegisterPassword.Password;
                string confirmPassword = (txtRegisterConfirmPasswordPlain.Visibility == Visibility.Visible) 
                    ? txtRegisterConfirmPasswordPlain.Text 
        ...
        private async void ButtonLogin_Clicked(object sender, RoutedEventArgs e)
        {
            ...
            string password = (txtPasswordPlain.Visibility == Visibility.Visible) 
            ...
            try
            {
                ...
                if (accountDb != null)
                {
                    Console.WriteLine($"[Login] Authentication success for {email}. Role: {role.RoleName}");
