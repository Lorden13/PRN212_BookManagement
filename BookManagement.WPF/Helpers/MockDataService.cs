...
namespace BookManagement.WPF.Helpers
{
    public static class MockDataService
    {
        ...
        {
            new PurchaseRecord { Id = 1, BookTitle = "The Art of Clean Code", ReaderName = "Jane Reader", PurchaseDate = new DateTime(2024, 3, 5), Price = 29.99m, Status = "Completed" },
            new PurchaseRecord { Id = 2, BookTitle = "Midnight Garden", ReaderName = "Michael Brown", PurchaseDate = new DateTime(2024, 4, 20), Price = 19.99m, Status = "Completed" },
            new PurchaseRecord { Id = 3, BookTitle = "Whispers in the Wind", ReaderName = "Jane Reader", PurchaseDate = new DateTime(2024, 6, 10), Price = 14.99m, Status = "Completed" },
            new PurchaseRecord { Id = 4, BookTitle = "Beyond the Stars", ReaderName = "Sarah Johnson", PurchaseDate = new DateTime(2024, 9, 15), Price = 25.99m, Status = "Processing" },
            new PurchaseRecord { Id = 5, BookTitle = "Data Science Essentials", ReaderName = "Michael Brown", PurchaseDate = new DateTime(2024, 8, 1), Price = 39.99m, Status = "Completed" },
            new PurchaseRecord { Id = 6, BookTitle = "The Silent Ocean", ReaderName = "Jane Reader", PurchaseDate = new DateTime(2024, 9, 20), Price = 22.99m, Status = "Cancelled" },
            new PurchaseRecord { Id = 7, BookTitle = "Cooking with Love", ReaderName = "Sarah Johnson", PurchaseDate = new DateTime(2024, 8, 12), Price = 32.99m, Status = "Completed" },
            new PurchaseRecord { Id = 8, BookTitle = "Financial Freedom", ReaderName = "Michael Brown", PurchaseDate = new DateTime(2024, 9, 25), Price = 28.99m, Status = "Cancelled" },
        };
